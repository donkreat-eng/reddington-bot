...
from fetch import fetch_with_retry, fetch_ohlc
from chart import generate_chart
from publish import post_pair
from post import weekly_caption, weekly_body
...
def build_data():
    ...
    return {
        ...
        "week_events": ["Календарь на следующую неделю обновляется"],
        "correlations": ["DXY: нейтрально", "XAU: без значимых изменений"],
